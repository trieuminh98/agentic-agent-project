...
npm_registry_env = {
    "npm_config_registry": os.getenv("NPM_CONFIG_REGISTRY", "https://registry.npmjs.org")
}
...
def researcher_mcp_server_params(name: str):
    return [
        {"command": "uvx", "args": ["mcp-server-fetch"]},
        {
            ...
            "env": brave_env | npm_registry_env,
        },
        {
            "command": "npx",
            "args": ["-y", "mcp-memory-libsql"],
            "env": {"LIBSQL_URL": f"file:./memory/{name}.db"} | npm_registry_env,
        },
    ]
